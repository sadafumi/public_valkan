...
void Test_Draw_2D_noTexture::Init(Utility::Int_Vec2 in_win, HWND hWnd, HINSTANCE hInstance)
{
	window_size = in_win;
...
void Test_Draw_2D_noTexture::Uninit()
{
...
void Test_Draw_2D_noTexture::Updata()
{
}

void Test_Draw_2D_noTexture::Draw()
{
