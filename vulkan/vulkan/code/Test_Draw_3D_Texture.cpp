...
void Test_Draw_3D_Texture::Init(Utility::Int_Vec2 in_win, HWND hWnd, HINSTANCE hInstance)
{
	window_size = in_win;
	...
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f,-0.5f,-0.5f, 1.0f), Utility::Vec2(1.f, 0.f)));  // lft-top-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f, 0.5f, 0.5f, 1.0f), Utility::Vec2(0.f, 1.f)));  // lft-btm-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f,-0.5f, 0.5f, 1.0f), Utility::Vec2(0.f, 0.f)));   // lft-top-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f, 0.5f, 0.5f, 1.0f), Utility::Vec2(0.f, 1.f)));  // lft-btm-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f,-0.5f,-0.5f, 1.0f), Utility::Vec2(1.f, 0.f)));  // lft-top-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f, 0.5f,-0.5f, 1.0f), Utility::Vec2(1.f, 1.f)));   // lft-btm-front
	//// front face													0.5f  0.5f	0.5f					 
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f,-0.5f,-0.5f, 1.0f), Utility::Vec2(0.f, 0.f)));  // lft-top-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f,-0.5f,-0.5f, 1.0f), Utility::Vec2(1.f, 0.f)));   // rgt-top-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f, 0.5f,-0.5f, 1.0f), Utility::Vec2(1.f, 1.f)));    // rgt-btm-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f,-0.5f,-0.5f, 1.0f), Utility::Vec2(0.f, 0.f)));  // lft-top-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f, 0.5f,-0.5f, 1.0f), Utility::Vec2(1.f, 1.f)));   // rgt-btm-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f, 0.5f,-0.5f, 1.0f), Utility::Vec2(0.f, 1.f)));   // lft-btm-front
	//// top face														0.5f 0.5f	0.5f					 
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f,-0.5f,-0.5f, 1.0f), Utility::Vec2(0.f, 1.f)));  // lft-top-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f,-0.5f, 0.5f, 1.0f), Utility::Vec2(1.f, 0.f)));  // rgt-top-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f,-0.5f,-0.5f, 1.0f), Utility::Vec2(1.f, 1.f)));   // rgt-top-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f,-0.5f,-0.5f, 1.0f), Utility::Vec2(0.f, 1.f)));  // lft-top-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f,-0.5f, 0.5f, 1.0f), Utility::Vec2(0.f, 0.f)));   // lft-top-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f,-0.5f, 0.5f, 1.0f), Utility::Vec2(1.f, 0.f)));    // rgt-top-back
	//// bottom face													0.5f 0.5f	0.5f					 
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f, 0.5f,-0.5f, 1.0f), Utility::Vec2(0.f, 0.f)));  // lft-btm-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f, 0.5f, 0.5f, 1.0f), Utility::Vec2(1.f, 1.f)));  // rgt-btm-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f, 0.5f, 0.5f, 1.0f), Utility::Vec2(0.f, 1.f)));   // lft-btm-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f, 0.5f,-0.5f, 1.0f), Utility::Vec2(0.f, 0.f)));  // lft-btm-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f, 0.5f,-0.5f, 1.0f), Utility::Vec2(1.f, 0.f)));   // rgt-btm-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f, 0.5f, 0.5f, 1.0f), Utility::Vec2(1.f, 1.f)));    // rgt-btm-back
	//// right face														 0.5f	0.5f					 
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f, 0.5f,-0.5f, 1.0f), Utility::Vec2(0.f, 1.f)));   // rgt-btm-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f,-0.5f, 0.5f, 1.0f), Utility::Vec2(1.f, 0.f)));   // rgt-top-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f, 0.5f, 0.5f, 1.0f), Utility::Vec2(1.f, 1.f)));   // rgt-btm-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f,-0.5f, 0.5f, 1.0f), Utility::Vec2(1.f, 0.f)));   // rgt-top-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f, 0.5f,-0.5f, 1.0f), Utility::Vec2(0.f, 1.f)));   // rgt-btm-front
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f,-0.5f,-0.5f, 1.0f), Utility::Vec2(0.f, 0.f)));  // rgt-top-front
	//// back face														 0.5f	0.5f					 
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f, 0.5f, 0.5f, 1.0f), Utility::Vec2(1.f, 1.f)));   // lft-btm-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f, 0.5f, 0.5f, 1.0f), Utility::Vec2(0.f, 1.f)));    // rgt-btm-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f,-0.5f, 0.5f, 1.0f), Utility::Vec2(1.f, 0.f)));  // lft-top-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4(-0.5f,-0.5f, 0.5f, 1.0f), Utility::Vec2(1.f, 0.f)));  // lft-top-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f, 0.5f, 0.5f, 1.0f), Utility::Vec2(0.f, 1.f)));    // rgt-btm-back
	//verticesData.push_back(vulkan::Resources::Vertex(Utility::Vec4( 0.5f,-0.5f, 0.5f, 1.0f), Utility::Vec2(0.f, 0.f)));  // rgt-top-back
...
void Test_Draw_3D_Texture::Uninit()
{
...
void Test_Draw_3D_Texture::Updata()
{
	this->desc_pool.Updata(&Device, &uniform_buff, false, NULL);
}

void Test_Draw_3D_Texture::Draw()
{
