...
namespace vulkan
{
	...
	namespace data
	{
		...
		public:
			...
			void Set_Window_Size(Utility::Int_Vec2);
			void Uninit();
			VkDevice device;
		...
		{
		public:
			static void Set_PhyDevicce(PhysicalDevice* in_PhyDevice);
			static bool memory_type_from_properties(uint32_t typeBits, VkFlags requirements_mask, uint32_t *typeIndex);
		private:
			static PhysicalDevice* PhyDevice;
		};
		class Surface
		{
		public:
			void Init(Window_Data in_data, Instance* in_Instance);
		...
		{
		public:
			void Init(PhysicalDevice*, Device*, Surface*, VkImageUsageFlags usageFlags = VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT | VK_IMAGE_USAGE_TRANSFER_SRC_BIT);
			void Uninit(Device*);
		...
		{
		public:
			void Init(Device* in_Device, PhysicalDevice* in_phyDevice);
		...
		{
		public:
			void Init( Device*, ImageView*, Render_Pass*, Depth_Buffer*, bool depth_flag);
			void Uninit(Device*);
	...
	namespace Resources
	{
		...
		public:
			...
			int vertex_size = 0;
			static void Create(Buffer*, std::vector<Vertex>/*const void *vertexData*/, int, bool use_texture, data::Device*);
			//static void Create_Model(Buffer*, std::vector<mfv::model::Vertex> in_vertex, int, mfv::model* in_data, data::Device*);
			static void Create_Model(Buffer*, std::vector<float> in_vertex, int, mfv::model* in_data, data::Device*);
			static void Set_InputAttri(std::vector<VkVertexInputAttributeDescription>* in_attri, mfv::model::Stride in_flag,int location, int* offset);
		...
		private:
			...
			static void Image(texture_object*, data::Device* in_Device, const char* tex_path, VkImageUsageFlags extraUsages, VkFormatFeatureFlags extraFeatures);
		...
		public:
			...
			static void Create(Texture*, data::Device*, const char* tex_path, VkImageUsageFlags extraUsages = 0, VkFormatFeatureFlags extraFeatures = 0);
